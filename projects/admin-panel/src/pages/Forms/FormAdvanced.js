                  ...
                  <Form action="#">
                    ...
                    <FormGroup>
                      ...
                      <Input
                        ...
                        defaultValue={this.state.colorHor}
                      />
                      {this.state.simple_color2 ? (
                        <SketchPicker
                          color="#fff"
                          defaultValue={this.state.simple_color2}
                          width="160px"
                    ...
                    <FormGroup className="mb-0">
                      ...
                      <Input
                        ...
                        defaultValue={this.state.colorCust}
                        onClick={() =>
                          this.setState({
                    ...
                    <FormGroup>
                      ...
                      <InputGroup>
                        ...
                        <input
                          type="number"
                          className="form-control"
                          defaultValue={this.state.data_attr}
                          placeholder="number"
                        />
                        <div
                          className="input-group-append"
                    ...
                    <FormGroup>
                      ...
                      <InputGroup>
                        ...
                        <input
                          type="number"
                          className="form-control"
                          defaultValue={this.state.postfix}
                          placeholder="number"
                        />
                    ...
                    <FormGroup>
                      ...
                      <InputGroup>
                        ...
                        <input
                          type="number"
                          className="form-control"
                          defaultValue={this.state.empty_val}
                          placeholder="number"
                        />
                        <div
                          className="input-group-append"
                    ...
                    <FormGroup>
                      ...
                      <InputGroup>
                        ...
                        <input
                          type="number"
                          className="form-control"
                          defaultValue={this.state.not_attr}
                          placeholder="number"
                        />
                        <div
                          className="input-group-append"
                    ...
                    <FormGroup className="mb-0">
                      ...
                      <InputGroup>
                        ...
                        <input
                          type="number"
                          className="form-control"
                          defaultValue={this.state.explicit_val}
                          placeholder="number"
                        />
                        <div
                          className="input-group-append"
                ...
                <CardBody>
                  ...
                  <form action="#">
                    ...
                    <div className="custom-file">
                      ...
                      <label
                        className="custom-file-label"
                        htmlFor="validatedCustomFileMultiple"
                      >
